...
nmap("<Leader>Md", cmd_t"delmarks!", base_t"Delete All Marks")
nmap("<C-w>Q", cmd_t"quit!", base_t"Force Quit")
...
nimap('<M-{>', cmd_t'BufferMovePrevious', base_t"Move Left")
nimap('<M-}>', cmd_t'BufferMoveNext', base_t"Move Right")
